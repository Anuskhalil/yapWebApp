        ...
        <Row>
          ...
          <Col md={4} className="mb-3">
            ...
            <Nav className="flex-column">
              <Nav.Link className='home text-white text-decoration-none' href="#home">Home</Nav.Link>
              <Nav.Link className='home text-white text-decoration-none' href="#about">About</Nav.Link>
              <Nav.Link className='home text-white text-decoration-none' href="#service">Service</Nav.Link>
              <Nav.Link className='home text-white text-decoration-none' href="#blog">Blog</Nav.Link>
              <Nav.Link className='home text-white text-decoration-none' href="#contact">Contact</Nav.Link>
            </Nav>
          </Col>
          <Col md={4} className="mb-3">
            <h3>Get In Touch</h3>
